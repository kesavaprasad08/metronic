                ...
                <div className='d-flex justify-content-between align-items-start flex-wrap mb-2'>
                  ...
                  {user?.timeZone !== "" &&
                    <div className='d-flex flex-wrap fw-bold fs-6 mb-4 pe-2'>
                      ...
                      >
                        <KTIcon iconName='geolocation' className='fs-4 me-1' />
                        {user?.timeZone == '' ? 'Select Location' : user?.timeZone}
                      </a>
                      <a
                        href='#'
                        className='d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2'
                      >
                        <KTIcon iconName='dollar' className='fs-4 me-1' />
                        {user?.currency == '' ? 'Select Currency' : user?.currency}
                      </a>
                      <a
                        href='#'
                        className='d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2'
                      >
                        <KTIcon iconName='paypal' className='fs-4 me-1' />
                        {user?.payment == "" ? "Payment Option" : user?.payment}
                      </a>
                      <a
                        href='#'
                        className='d-flex align-items-center text-gray-500 text-hover-primary mb-2'
                      >
                        <KTIcon iconName='update-file' className='fs-4 me-1' />
